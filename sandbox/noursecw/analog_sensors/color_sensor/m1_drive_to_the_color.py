...
def drive_to_color(button_state, robot, color_to_seek):
    ...
    if button_state:
        ...
        if COLOR_NAMES[color_to_seek] == 'Red':
            while robot.color_sensor.color != ev3.ColorSensor.COLOR_RED:
                robot.drive_forward(300, 300)
        if COLOR_NAMES[color_to_seek] == 'Blue':
            while robot.color_sensor.color != ev3.ColorSensor.COLOR_BLUE:
                robot.drive_forward(300, 300)
        if COLOR_NAMES[color_to_seek] == 'Black':
            while robot.color_sensor.color != ev3.ColorSensor.COLOR_BLACK:
                robot.drive_forward(300, 300)
        if COLOR_NAMES[color_to_seek] == 'White':
