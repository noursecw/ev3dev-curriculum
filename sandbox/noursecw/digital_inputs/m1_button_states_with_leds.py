...
Much like we did in noursecw of the motors unit, later we will show you different (better) ways to use buttons.

Authors: David Fisher and Aaron Klaustermeier.
    ...
    while True:
        ...
        if btn.down:
            ...
            ev3.Leds.set_color(ev3.Leds.LEFT,
                               led_colors[current_color_index % 4])
            ev3.Leds.set_color(ev3.Leds.RIGHT,
                               led_colors[current_color_index % 4])
            while True:
                if not btn.down:
                    break
