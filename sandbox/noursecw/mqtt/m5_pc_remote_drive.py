...
Authors: David Fisher and Tiarnan Rice.
...
def main():
    ...
    forward_button['command'] = lambda: drive_forward(mqtt_client,
                                                      ...
                                                      right_speed_entry)
    root.bind('<Up>',
              lambda event: drive_forward(mqtt_client, left_speed_entry,
                                          right_speed_entry))
    ...
    back_button['command'] = lambda: drive_backwards(mqtt_client,
                                                     left_speed_entry,
                                                     right_speed_entry)
    root.bind('<Down>',
              lambda event: drive_backwards(mqtt_client, left_speed_entry,
                                            right_speed_entry))
